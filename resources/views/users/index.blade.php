    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 pl-0">
                @can('user-create')
                    <h3><a href="{{ route('users.create') }}" class="btn btn-outline btn-info">+ @lang('Add New User')</a>
                    </h3>
                @endcan
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('short-link.index') }}">@lang('Dashboard')</a></li>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                @canany(['user-update', 'user-delete'])
                                    <td>
                                        @can('user-update')
                                        <a href="{{ route('users.edit', $user->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                        @endcan
                                        @can('user-delete')
                                            <a href="#" data-href="{{ route('users.destroy', $user->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                        @endcan
                                    </td>
                                @endcanany
                            </tr>
